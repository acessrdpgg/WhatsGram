        ...
        if (msg.body == "!allow" && config.pmguard_enabled == "true" && !msg.to.includes("-")) { // allow and unmute the chat (PMPermit module)
           ...
           msg.delete(true);
            ...
            if(contact != undefined) {
                ...
                const pfpMedia = await await MessageMedia.fromUrl('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTvVloLUhK0N74Z76rkYtOM1S5n4a6436bMteyrjIQjkSWP96krl8WdIk&s=10', {unsafeMime: true});
